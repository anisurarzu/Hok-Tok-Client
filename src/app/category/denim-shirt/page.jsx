...
export default function DenimShirt() {
      ...
      try {
        ...
        if (res?.status === 200) {
          const filteredProducts = res?.data.filter(
            (product) => product.subCategory === "DENIM Shirt"
          );
    ...
    <div className="min-h-screen bg-gray-100 pb-10">
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="text-sm text-gray-600">
          ...
          {" > "}
          <span className="text-gray-800 font-medium">DENIM SHIRT</span>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-3/4">
              ...
              <div className="bg-white p-4 rounded shadow-sm mb-4 flex justify-between items-center">
                <h1 className="text-xl font-semibold">DENIM SHIRT</h1>
                <div className="text-sm text-gray-600">
                  {products.length} items found in DENIM SHIRT
                </div>
              </div>
