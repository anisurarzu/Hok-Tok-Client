...
export default function DenimJacket() {
      ...
      try {
        ...
        if (res?.status === 200) {
          const filteredProducts = res?.data.filter(
            (product) => product.subCategory === "Denim Jacket"
          );
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-3/4">
              ...
              <div className="bg-white p-4 rounded shadow-sm mb-4 flex justify-between items-center">
                <h1 className="text-xl font-semibold">DENIM JACKET</h1>
                <div className="text-sm text-gray-600">
                  {products.length} items found in DENIM JACKET
                </div>
              </div>
